...
u8 MPORT_enuArrPinConfig[MPORT_NUM_OF_PORTS * MPORT_NUM_OF_PINS] =
{
	...
	PIN_INPUT_PULLUP,  // B0: Input Pull-Up
	PIN_INPUT_PULLDOWN,  // B1: Input Pull-Down
	...
	PIN_OUTPUT,  // C0: Output
	PIN_OUTPUT,  // C1: Output
	PIN_OUTPUT,  // C2: Output
	PIN_OUTPUT,  // C3: Output
	PIN_OUTPUT,  // C4: Output
	PIN_OUTPUT,  // C5: Output
	PIN_OUTPUT,  // C6: Output
	PIN_OUTPUT,  // C7: Output
